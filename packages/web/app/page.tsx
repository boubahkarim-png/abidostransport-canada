...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://abidostransport.ca/',
    languages: {
      'en-CA': '/',
      'fr-CA': '/fr',
    },
      ...
      <header className="bg-white shadow-lg sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link href="/quote" className="text-gray-700 hover:text-blue-600 font-medium">Free Quote</Link>
          ...
          <Link href="/quote" className="bg-blue-600 text-white px-5 py-2.5 rounded-lg font-semibold hover:bg-blue-700 transition-colors">
            Get Free Quote
          </Link>
        </div>
      </header>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <Link href="/quote" className="bg-white text-blue-900 px-8 py-4 rounded-lg font-bold hover:bg-blue-50 transition-colors shadow-xl">
              ...
              <div className="hidden lg:block bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                ...
                <form className="space-y-4">
                  ...
                  <Link href="/quote" className="block w-full bg-gradient-to-r from-green-500 to-green-600 text-white py-4 rounded-lg font-bold text-center hover:from-green-600 hover:to-green-700">
                    Get My Free Quote →
                  </Link>
                </form>
              </div>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><Link href="/services" className="hover:text-white">Car Transport Quebec</Link></li>
                <li><Link href="/services" className="hover:text-white">Auto Transport Ontario</Link></li>
                <li><Link href="/services" className="hover:text-white">Snowbird Transport</Link></li>
                <li><Link href="/services" className="hover:text-white">Dealer Transport</Link></li>
                <li><Link href="/services" className="hover:text-white">Luxury Car Shipping</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-bold mb-4">Areas Served</h4>
              <ul className="space-y-2 text-gray-400 text-sm">
                <li><Link href="/" className="hover:text-white">Montreal</Link></li>
                <li><Link href="/" className="hover:text-white">Quebec City</Link></li>
                <li><Link href="/" className="hover:text-white">Toronto</Link></li>
                <li><Link href="/" className="hover:text-white">Ottawa</Link></li>
                <li><Link href="/" className="hover:text-white">All Canada & USA</Link></li>
              </ul>
            </div>
            <div>
